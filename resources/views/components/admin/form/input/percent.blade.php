@props(['name', 'id', 'class', 'value', 'min', 'max', 'step', 'placeholder', 'required', 'readonly', 'disabled', 'error', 'showIcon'])
...
<div class="new-input-parent flex rounded-lg {{ $error ? 'ring-2 ring-red-600' : ''}}">
    @if($showIcon)
        <div
            ...
            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 icon icon-tabler icon-tabler-percentage" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
