<x-admin.layout.admin-layout>
    ...
    <x-admin.form.form id="tags" formWide="w-1/2" role="form" method="POST" :redirectUrl="$redirectUrl"
        ...
        <div>
            <input type="hidden" name="type" value="{{ \App\Models\Promotion::TYPE_ON_DISH }}">
        ...
        <div>
            ...
            <x-admin.form.new-input type="select" id="promotion_orderDish" name="orderDish[id]" :required="true"
                                    :value="route('admin.promotions.dish', ['id' => $data->id])"
                                    :oldValue="$oldValues['orderDish']" />
        </div>
        <div class="promotion-dates-container justify-space-between flex flex-col 2xl:flex-row gap-6">
            <div class="flex-1">
                ...
                <x-admin.form.new-input type="date" id="promotion_startAt" name="startAt"
                                        value="{{ $oldValues['startAt'] }}" min="0" max="99" placeholder="Od dnia"
        ...
        <div class="justify-space-between flex gap-6">
            <div class="flex-1">
                <x-admin.form.new-input type="toggle" id="promotion_merge" name="merge" :checked="$oldValues['merge']"
