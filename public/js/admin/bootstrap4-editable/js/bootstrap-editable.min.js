...
!(function (a) {
    ...
    (b.prototype = {
        ...
        error: function (b) {
            ...
            if (b === !1)
                d.removeClass(a.fn.editableform.errorGroupClass),
                    e
                        .removeClass(a.fn.editableform.errorBlockClass)
                        .empty()
                        .hide();
            else {
                if (b) {
                ...
                d.addClass(a.fn.editableform.errorGroupClass),
                    e
                        .addClass(a.fn.editableform.errorBlockClass)
                        .html(b)
                        .show();
            }
        },
        submit: function (b) {
            ...
            if ("object" === a.type(d) && void 0 !== d.newValue) {
                if (
                    ...
                    return this.error(d.msg), void this.showForm();
                        ...
                        a.proxy(function (a) {
                            ...
                            var b =
                                "function" == typeof this.options.success
                                    ...
                                    : null;
                            return b === !1
                                ? (this.error(!1), void this.showForm(!1))
                                : "string" == typeof b
                                  ? (this.error(b), void this.showForm())
                                  : (b &&
                                        "object" == typeof b &&
                                    ...
                                    this.error(!1),
                                    (this.value = c),
                                    void this.$div.triggerHandler("save", {
                                        newValue: c,
                                        submitValue: e,
                                        response: a,
                                    }));
        ...
        save: function (b) {
            this.options.pk = a.fn.editableutils.tryParseJson(
                this.options.pk,
                !0,
            );
            var c,
        ...
        setValue: function (a, b) {
            b ? (this.value = this.input.str2value(a)) : (this.value = a),
                this.$form &&
            ...
            sliceObj: function (b, c, d) {
                ...
                for (var h = 0; h < c.length; h++)
                    (e = c[h]),
                        ...
                        d !== !0 &&
                            ((f = e.toLowerCase()),
                            b.hasOwnProperty(f) && (g[e] = b[f]));
                return g;
            },
            getConfigData: function (b) {
                var c = {};
                return (
                    a.each(b[0].dataset, function (a, b) {
                        ("object" != typeof b ||
                            (b &&
                                "object" == typeof b &&
                    ...
                    "date" === f &&
                        ("inline" === b.mode
                            ? a.fn.editabletypes.datefield
                                ? (f = "datefield")
                                : a.fn.editabletypes.dateuifield &&
                                  (f = "dateuifield")
    ...
    (function (a) {
        ...
        (b.prototype = {
                ...
                (this.$element = a(c)),
                    ...
                    a(document).data("editable-handlers-attached") ||
                        (a(document).on("keyup.editable", function (b) {
                            27 === b.which &&
                                a(".editable-open").editableContainer(
                                    "hide",
                                    "cancel",
                                );
                        }),
                        a(document).on("click.editable", function (c) {
                            ...
                            if (
                                !a(".select2-drop-mask").is(":visible") &&
                                a.contains(
            ...
            call: function () {
                this.$element[this.containerName].apply(
                    this.$element,
                    arguments,
                );
            },
            ...
            hide: function (a) {
                if (
                    ...
                    if (this.$form.data("editableform").isSaving)
                        return void (this.delayedHide = { reason: a });
                    (this.delayedHide = !1),
            ...
            option: function (a, b) {
                (this.options[a] = b),
                    a in this.containerOptions
                        ? ((this.containerOptions[a] = b),
                          this.setContainerOption(a, b))
                        : ((this.formOptions[a] = b),
                          this.$form &&
                              this.$form.editableform("option", a, b));
            },
    ...
    (function (a) {
        ...
        (b.prototype = {
                    ...
                    switch (
                        ...
                        null === this.options.value
                            ? ((this.value = this.input.html2value(
                              ...
                              (c = !0))
                            : ((this.options.value =
                                  a.fn.editableutils.tryParseJson(
                                      this.options.value,
                                      !0,
                                  )),
                              "string" == typeof this.options.value
                                  ? (this.value = this.input.str2value(
                                        this.options.value,
                                    ))
                ...
                (this.options.selector = !1),
                    ...
                    this.$element.on(
                        ...
                        a.proxy(function (c) {
                            ...
                            d.data("editable") ||
                                (d.hasClass(this.options.emptyclass) &&
                                    d.empty(),
                                d.editable(this.options).trigger(c));
                        }, this),
                    );
            },
            render: function (a) {
            ...
            setValue: function (b, c, d) {
                c ? (this.value = this.input.str2value(b)) : (this.value = b),
                    this.container &&
                ...
                switch (c) {
                    ...
                    case "submit":
                        ...
                        if (a.isEmptyObject(i)) {
                            ...
                            "function" == typeof g.error && g.error.call(h, i);
                        return this;
                }
                return this.each(function () {
                    var d = a(this),
                ...
                doPrepend: function () {
                    null !== this.options.prepend &&
                        ...
                        (a.isArray(this.prependData) ||
                            ...
                            (this.prependData = this.makeArray(
                                this.options.prepend,
                            ))),
                        a.isArray(this.prependData) &&
                            a.isArray(this.sourceData) &&
                            (this.sourceData = this.prependData.concat(
                                this.sourceData,
                            )));
                },
                renderList: function () {},
    ...
    (function (a) {
        ...
        a.fn.editableutils.inherit(b, a.fn.editabletypes.abstractinput),
            ...
            (b.defaults = a.extend(
                {},
                a.fn.editabletypes.abstractinput.defaults,
                { tpl: '<input type="text">', placeholder: null, clear: !0 },
            )),
                            ...
                            if (a.isArray(e))
                                for (var g = 0; g < e.length; g++)
                                    if (((f = {}), e[g].children))
                                        ...
                                        (f.value = e[g].value),
                                            e[g].disabled && (f.disabled = !0);
                                        var h = a("<option>", f);
                                        h[b ? "text" : "html"](e[g].text),
                                            d.append(h);
                                    }
                            return d;
                        };
                ...
                renderList: function () {
                    ...
                    if ((this.$tpl.empty(), a.isArray(this.sourceData))) {
                        for (var c = 0; c < this.sourceData.length; c++) {
                            ...
                            var d = a("<span>");
                            d[this.options.escape ? "text" : "html"](
                                " " + this.sourceData[c].text,
                            ),
                                b.append(d),
                                a("<div>").append(b).appendTo(this.$tpl);
                        }
                        (this.$input = this.$tpl.find(
                            'input[type="checkbox"]',
                        )),
                            this.setClass();
                    }
                ...
                value2htmlFinal: function (b, c) {
                    ...
                    e.length
                        ? (a.each(e, function (b, c) {
                              var e = f
                                  ? a.fn.editableutils.escape(c.text)
                                  : c.text;
                              d.push(e);
                          }),
                          a(c).html(d.join("<br>")))
            ...
            a.extend(b.prototype, {
                ...
                value2html: function (c, d) {
                    ...
                    this.options.select2.tags
                        ...
                        (f = a.isArray(f)
                            ? f.join(this.options.viewseparator)
                            : f),
        ...
        (b.prototype = {
            ...
            getTemplate: function () {
                var b = this.options.template,
                    c = this.$element.prop("disabled"),
                    d = this.options.customClass;
                return (
            ...
            fillCommon: function (a) {
                ...
                if ("name" === this.options.firstItem) {
                    b = moment.localeData
                        ? moment.localeData()._relativeTime
                        : moment.relativeTime ||
                          moment.langData()._relativeTime;
                    var d =
                        "function" == typeof b[a] ? b[a](1, !0, a, !1) : b[a];
            ...
            fillMonth: function () {
                var a,
                    b,
                    c = this.fillCommon("M"),
                    d = -1 !== this.options.template.indexOf("MMMMMM"),
                    e = -1 !== this.options.template.indexOf("MMMMM"),
                    f = -1 !== this.options.template.indexOf("MMMM"),
                    g = -1 !== this.options.template.indexOf("MMM"),
                    h = -1 !== this.options.template.indexOf("MM");
                for (b = 0; 11 >= b; b++)
                    (a = d
                        ? moment().date(1).month(b).format("MM - MMMM")
                        : e
                          ? moment().date(1).month(b).format("MM - MMM")
                          : f
            ...
            fillYear: function () {
                ...
                for (b = this.options.maxYear; b >= this.options.minYear; b--)
                    (a = d ? b : (b + "").substring(2)),
                        c[this.options.yearDescending ? "push" : "unshift"]([
                            b,
                            a,
                        ]);
            ...
            fillHour: function () {
                var a,
                    ...
                    e =
                        ...
                        -1 !==
                            this.options.template.toLowerCase().indexOf("hh")),
                    f = d ? 1 : 0,
                    g = d ? 12 : 23;
                for (b = f; g >= b; b++)
            ...
            setValue: function (b) {
                ...
                if (b) {
                    var d =
                            "string" == typeof b
                                ? moment(b, this.options.format, !0)
                                : moment(b),
                        e = this,
                        f = {};
                    d.isValid()
                        ? (a.each(this.map, function (a, b) {
                          ...
                          this.$element
                              .val(d.format(this.options.format))
                              .change(),
                          (this.datetime = d))
                        : (this.datetime = null);
                }
    ...
    (function (a) {
        ...
        var b = function (c) {
            this.init("combodate", c, b.defaults),
                ...
                (c.combodate = a.fn.editableutils.tryParseJson(
                    c.combodate,
                    !0,
                )),
    ...
    (function (a) {
        ...
        e.prototype = {
                ...
                c.startDate !== -(1 / 0) &&
                    ...
                    a.isArray(c.daysOfWeekDisabled) ||
                        (c.daysOfWeekDisabled =
                            c.daysOfWeekDisabled.split(/[,\s]*/)),
                    (c.daysOfWeekDisabled = a.map(
                        c.daysOfWeekDisabled,
                        function (a) {
            ...
            setDate: function (a) {
                this.setUTCDate(
                    new Date(a.getTime() - 6e4 * a.getTimezoneOffset()),
                );
            },
            ...
            fill: function () {
                ...
                m.setUTCDate(n),
                    m.setUTCDate(
                        n - ((m.getUTCDay() - this.o.weekStart + 7) % 7),
                    );
                var o = new Date(m);
                ...
                for (var p, q = []; m.valueOf() < o; ) {
                    if (
                        ...
                        var r = new Date(
                                +m +
                                    ((this.o.weekStart - m.getUTCDay() - 7) %
                                        7) *
                                        864e5,
                            ),
                            s = new Date(
                                +r + ((11 - r.getUTCDay()) % 7) * 864e5,
                            ),
                            t = new Date(
                        ...
                        (b = 38 == a.keyCode ? -1 : 1),
                            a.ctrlKey
                                ...
                                : a.shiftKey
                                  ...
                                  : ((c = new Date(this.date)),
                                    c.setUTCDate(
                                        this.date.getUTCDate() + 7 * b,
                                    ),
                                    (d = new Date(this.viewDate)),
                                    d.setUTCDate(
                                        this.viewDate.getUTCDate() + 7 * b,
                                    )),
                            this.dateWithinRange(c) &&
                                ((this.date = c),
                                (this.viewDate = d),
                    ...
                    this.each(function () {
                        ...
                        if (!k) {
                            ...
                            if (j.is(".input-daterange") || p.inputs) {
                                var q = {
                                    inputs:
                                        p.inputs || j.find("input").toArray(),
                                };
                                j.data(
                                    "datepicker",
                                    (k = new f(this, a.extend(p, q))),
                                );
                ...
                parseDate: function (c, d, f) {
                    ...
                    if (
                        ...
                        for (var m = 0; m < j.length; m++)
                            switch (
                                ((g = i.exec(j[m])), (h = parseInt(g[1])), g[2])
                            ) {
                                case "d":
                                    c.setUTCDate(c.getUTCDate() + h);
                                    break;
                                case "m":
                                    c = e.prototype.moveMonth.call(
                                        e.prototype,
                                        c,
                                        h,
                                    );
                    ...
                    if (
                        ...
                        for (var m = 0, t = s.length; t > m; m++) {
                            if (
                                ((n = parseInt(j[m], 10)), (g = s[m]), isNaN(n))
                            )
                                switch (g) {
                                    case "MM":
                                        (o = a(k[f].months).filter(function () {
                                            ...
                                            (n =
                                                a.inArray(o[0], k[f].months) +
                                                1);
                                        break;
                                    case "M":
                                        (o = a(k[f].monthsShort).filter(
                                            function () {
                                                var a = this.slice(
                                                        0,
                                                        j[m].length,
        ...
        (l.template =
            ...
            a(document).on(
                ...
                function (b) {
                    var c = a(this);
                    c.data("datepicker") ||
                        (b.preventDefault(), h.call(c, "show"));
                },
            ),
            a(function () {
        ...
        a.fn.editableutils.inherit(b, a.fn.editabletypes.abstractinput),
            a.extend(b.prototype, {
                initPicker: function (b, c) {
                    this.options.viewformat ||
                        (this.options.viewformat = this.options.format),
                        (b.datepicker = a.fn.editableutils.tryParseJson(
                            b.datepicker,
                            !0,
                        )),
                    ...
                    this.$input.bdatepicker(this.options.datepicker),
                        this.options.clear &&
                            ...
                            this.$tpl
                                .parent()
                                .append(
                                    a('<div class="editable-clear">').append(
                                        this.$clear,
                                    ),
                                ));
                },
    ...
    (function (a) {
        "use strict";
        var b = function (a) {
            this.init("datetime", a, b.defaults),
                this.initPicker(a, b.defaults);
        };
        a.fn.editableutils.inherit(b, a.fn.editabletypes.abstractinput),
            a.extend(b.prototype, {
                ...
                render: function () {
                    this.$input.datetimepicker(this.options.datetimepicker),
                        this.$input.on("changeMode", function (b) {
                ...
                value2html: function (a, c) {
                    var d = a
                        ...
                        : "";
                    return c
                        ? void b.superclass.value2html.call(this, d, c)
                        : d;
                },
                html2value: function (a) {
                ...
                toUTC: function (a) {
                    return a
                        ? new Date(a.valueOf() - 6e4 * a.getTimezoneOffset())
                        : a;
                },
                fromUTC: function (a) {
                    return a
