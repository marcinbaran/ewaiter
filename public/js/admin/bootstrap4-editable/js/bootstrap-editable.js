    ...
    EditableForm.prototype = {
        ...
        **/
        ...
        save: function (submitValue) {
            ...
            this.options.pk = $.fn.editableutils.tryParseJson(
                this.options.pk,
                true,
            );
            ...
            */
            ...
            if (send) {
                ...
                if (typeof this.options.params === "function") {
                    params = this.options.params.call(
                        this.options.scope,
                        params,
                    );
                } else {
    ...
    $.fn.editableform = function (option) {
        ...
        return this.each(function () {
            ...
            if (!data) {
                $this.data(
                    "editableform",
                    (data = new EditableForm(this, options)),
                );
            }
            ...
            $.each(sourceData, function (i, o) {
                if (o.children) {
                    ...
                    if (isValArray) {
                        ...
                        var itemValue =
                            o && typeof o === "object" ? valueProp(o) : o;
                        if (value == itemValue) {
                            result.push(o);
                        }
                    }
                ...
                if (arguments.length === 2 && arguments[1] === true) {
                    ...
                    this.each(function () {
                        ...
                        if (
                            ...
                            result[data.options.name] = data.input.value2submit(
                                data.value,
                            );
                        }
                    });
            ...
            case "submit": //collects value, validate and submit to server for creating new record
                ...
                if ($.isEmptyObject(errors)) {
                    ...
                    if ($elems.length === 1) {
                        ...
                        config.success =
                            config.success || editable.options.success;
...
(function ($) {
    ...
    $.extend(List.prototype, {
        ...
        doPrepend: function () {
            if (
                this.options.prepend === null ||
                this.options.prepend === undefined
            ) {
                return;
            }
    ...
    $.extend(Checklist.prototype, {
        ...
        str2value: function (str) {
            ...
            if (typeof str === "string" && str.length) {
                reg = new RegExp(
                    "\\s*" + $.trim(this.options.separator) + "\\s*",
                );
                value = str.split(reg);
            } else if ($.isArray(str)) {
                value = str;
        ...
        value2htmlFinal: function (value, element) {
            var html = [],
                checked = $.fn.editableutils.itemsByValue(
                    value,
                    this.sourceData,
                ),
...
(function ($) {
    ...
    $.extend(Constructor.prototype, {
        ...
        value2html: function (value, element) {
            ...
            text = $.isArray(text)
                ? text.join(this.options.viewseparator)
                : text;
        ...
        fillCommon: function (key) {
            ...
            if (this.options.firstItem === "name") {
                ...
                if (moment.localeData) {
                    ...
                    relTime =
                        moment.relativeTime || moment.langData()._relativeTime;
                }
                var header =
                        ...
                        if (!target.is(".disabled")) {
                            ...
                            if (target.is(".month")) {
                                ...
                                if (this.o.minViewMode === 1) {
                                    this._setDate(
                                        UTCDate(year, month, day, 0, 0, 0, 0),
                                    );
                                }
                            } else {
        ...
        render: function () {
            ...
            if (this.options.clear) {
                ...
                this.$tpl
                    .parent()
                    .append(
                        $('<div class="editable-clear">').append(this.$clear),
                    );
            }
        },
