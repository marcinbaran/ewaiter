                        ...
                        range_createClass(WrappedRange, [
                            ...
                            },
                            {
                                ...
                                value: function expand(pred) {
                                    var startAncestor = dom.ancestor(
                                        this.sc,
                                        pred,
                                    );
                                    var endAncestor = dom.ancestor(
                                        this.ec,
                                        pred,
                                    );
                            ...
                            },
                            {
                                ...
                                value: function isLeftEdgeOf(pred) {
                                    ...
                                    return (
                                        node && dom.isLeftEdgeOf(this.sc, node)
                                    );
                                },
                                /**
                    ...
                    (function () {
                        function Editor(context) {
                            ...
                            this.fontSize = this.wrapCommand(function (value) {
                                var unit =
                                    _this.currentStyle()["font-size-unit"];
                            ...
                            this.fontSizeUnit = this.wrapCommand(
                                function (value) {
                                    var size =
                                        _this.currentStyle()["font-size"];
                            ...
                            this.insertOrderedList = this.wrapCommand(
                                function () {
                                    _this.bullet.insertOrderedList(
                                        _this.editable,
                                    );
                                },
                            );
                            ...
                            this.pasteHTML = this.wrapCommand(
                                function (markup) {
                            ...
                            this.formatBlock = this.wrapCommand(
                            ...
                            this.lineHeight = this.wrapCommand(
                                function (value) {
                                    _this.style.stylePara(
                                        _this.getLastRange(),
                                        {
                                            lineHeight: value,
                                        },
                            ...
                            this.createLink = this.wrapCommand(
                                function (linkInfo) {
                                    ...
                                    var rng =
                                        linkInfo.range || _this.getLastRange();
                                    ...
                                    var isTextChanged =
                                        rng.toString() !== linkText; // handle spaced urls from input
                                    ...
                                    if (_this.options.onCreateLink) {
                                        linkUrl =
                                            _this.options.onCreateLink(linkUrl);
                            ...
                            this.foreColor = this.wrapCommand(
                                function (colorInfo) {
                                    document.execCommand(
                                        "foreColor",
                                        false,
                                ...
                                value: function attachDragAndDropEvent() {
                                    ...
                                    this.$dropzone
                                        .on("drop", function (event) {
                                            var dataTransfer =
                                                event.originalEvent
                                                    .dataTransfer; // stop the browser from opening the dropped content
                    ...
                    (function () {
                        function AutoLink(context) {
                            ...
                            this.events = {
                                ...
                                "summernote.keydown":
                                    function summernoteKeydown(we, e) {
                                        ...
                                        function (match) {
                                            if (match) {
                                                ...
                                                if (typeof match === "string") {
                                                    node =
                                                        dom.createText(match);
                                                } else if (
                                                    match instanceof jQuery
                                                ) {
                                                    node = match[0];
                                                } else if (
                                                    match instanceof Node
                                                ) {
                                                    node = match;
                                                }
                        ...
                        Buttons_createClass(Buttons, [
                            {
                                ...
                                value: function representShortcut(
                                    editorMethod,
                                ) {
                                    var shortcut =
                            ...
                            },
                            {
                                ...
                                value: function isFontDeservedToAdd(name) {
                                    ...
                                    return (
                                        ...
                                        env.genericFontFamilies.indexOf(
                                            name,
                                        ) === -1
                                    );
                                },
                                ...
                                value: function addToolbarButtons() {
                                    ...
                                    this.context.memo(
                                        ...
                                        function () {
                                            ...
                                            if (
                                                _this2.options.addDefaultFonts
                                            ) {
                                            ...
                                            return _this4
                                                .button({
                                                    contents: _this4.ui.icon(
                                                        _this4.options.icons
                                                            .link,
                                                    ),
                                                    tooltip:
                                                        _this4.lang.link.edit,
                            ...
                            {
                                key: "updateBtnStates",
                                value: function updateBtnStates(
                                    $container,
                                    infos,
                                ) {
                                    var _this7 = this;
                            ...
                            },
                            {
                                ...
                                value: function tableMoveHandler(event) {
                                    ...
                                    var dim = {
                                        c:
                                            Math.ceil(
                                                posOffset.x / PX_PER_EM,
                                            ) || 1,
                                        r:
                                            Math.ceil(
                                                posOffset.y / PX_PER_EM,
                                            ) || 1,
                                    };
                                    $highlighted.css({
                                        width: dim.c + "em",
                                    ...
                                    if (
                                        dim.c > 3 &&
                                        dim.c <
                                            this.options.insertTableMaxSize.col
                                    ) {
                                        $unhighlighted.css({
                                            width: dim.c + 1 + "em",
                                        });
                                    ...
                                    if (
                                        dim.r > 3 &&
                                        dim.r <
                                            this.options.insertTableMaxSize.row
                                    ) {
                                        $unhighlighted.css({
                                            height: dim.r + 1 + "em",
                                        });
                        ...
                        Toolbar_createClass(Toolbar, [
                            ...
                            },
                            {
                                ...
                                value: function followScroll() {
                                    ...
                                    var statusbarHeight =
                                        this.$statusbar.height(); // check if the web app is currently using another static bar
