    ...
    return (function (t) {
        ...
        3: function (t, e, n) {
            ...
            function K(t) {
                ...
                return (
                    0 === e ||
                    (!E(t) && 1 === e && t.innerHTML === U) ||
                    !(!x.all(t.childNodes, E) || "" !== t.innerHTML)
                );
            }
            function q(t) {
            ...
            var ft = {
                ...
                isVisiblePoint: function (t) {
                    if (E(t.node) || !ot(t.node) || K(t.node)) return !0;
                ...
                isCustomStyleTag: function (t) {
                    return (
                        t && !E(t) && x.contains(t.classList, "note-styletag")
                    );
                },
            };
            function pt(t, e) {
                    ...
                    (this.insertParagraph = this.wrapCommand(function () {
                        ...
                        (this.insertNode = this.wrapCommand(function (t) {
                            n.isLimited(i()(t).text().length) ||
                                ...
                                n.setLastRange(
                                    yt.createFromNodeAfter(t).select(),
                                ));
                        })),
                        (this.insertText = this.wrapCommand(function (t) {
                            if (!n.isLimited(t.length)) {
                                ...
                                n.setLastRange(
                                    yt.create(e, ft.nodeLength(e)).select(),
                                );
                            }
                        })),
                        (this.pasteHTML = this.wrapCommand(function (t) {
                            if (!n.isLimited(t.length)) {
                                ...
                                n.setLastRange(
                                    yt.createFromNodeAfter(x.last(e)).select(),
                                );
                            }
                        })),
                        ...
                        },
                        {
                            ...
                            value: function () {
                                ...
                                if (t.length) {
                                    ...
                                    } else yt.createFromNodeAfter(e).select();
                                    (this.lastWordRange = null),
                                        this.hide(),
